...
{
    public class WebPartMock
    {


        public override Microsoft.SharePoint.Client.WebParts.WebPartExportMode ExportMode => ExportModeEx;
        public Microsoft.SharePoint.Client.WebParts.WebPartExportMode ExportModeEx { get; set; }
