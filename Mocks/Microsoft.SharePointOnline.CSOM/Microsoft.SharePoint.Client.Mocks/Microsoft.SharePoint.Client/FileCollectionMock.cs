...
namespace Microsoft.SharePoint.Client
{
    public class FileCollectionMock : FileCollection
    {
        ...
        public override Microsoft.SharePoint.Client.File AddUsingPath(Microsoft.SharePoint.Client.ResourcePath @path, Microsoft.SharePoint.Client.FileCollectionAddParameters @parameters, System.IO.Stream @contentStream)
        {
            return AddUsingPathEx;
        }
        public Microsoft.SharePoint.Client.File AddUsingPathEx { get; set;}
